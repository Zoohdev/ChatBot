function init() {
    ...
    res_elm.innerHTML="Hello Gorgeous, My name is Zooh. How may I help you?" ;
    res_elm.setAttribute("class","left");
 
    document.getElementById('message-area').appendChild(res_elm);
}
...
document.getElementById('reply').addEventListener("click", async (e) => {
    ...
    function scroll() {
        var scrollMsg = document.getElementById('message-area')
